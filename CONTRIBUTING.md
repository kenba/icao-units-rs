...
If you've noticed a bug or have a feature request then please raise a [new issue](https://github.com/kenba/icao-units-rs/issues/new).
It's generally best to check the [issues](https://github.com/kenba/icao-units-rs/issues) and [pull requests](https://github.com/kenba/icao-units-rs/pulls) (open and closed) to ensure that someone else has not noticed it before you. I recommend that you wait for confirmation of your bug or approval for your feature request in this way before starting to code.
...
```shell
git remote add upstream git@github.com:kenba/icao-units-rs.git
git checkout develop
